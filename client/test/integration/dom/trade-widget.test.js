...
describeInDom('A Trade widget', function (domContext) {
	...
	it.skip('is rendered in the given div', function () {
	...
	it.skip('renders a panel for both trade players', function () {
		domContext.assertElementCount('.monopoly-trade-player-panel', 2);
	});
	
	it.skip('renders the name of both trade players', function () {
		domContext.assertElementCount('.monopoly-trade-player-name', 2);
	});
	
	it.skip('renders a property list for both players', function () {
		domContext.assertElementCount('.monopoly-trade-player-properties', 2);
	});
	
	it.skip('renders each property in the list', function () {
	...
	//  TODO seems like d3 .on() function is not called in tests, because it works live
	it.skip('clicking on a property selects it', function () {
	...
	it.skip('renders a money spinner for both players', function () {
		domContext.assertElementCount('.monopoly-trade-player-money-spinner', 2);
	});
	
	it.skip('entering an amount in the money spinner changes the offer', function () {
		var selector = '.monopoly-trade-player-panel[data-ui=' + currentPlayer.id() +
	...
	it.skip('renders the money total for both players', function () {
		domContext.assertElementCount('.monopoly-trade-player-money-total', 2);
	});
	
	it.skip('renders a button to make the offer', function () {
		domContext.assertOneOf('[data-ui=make-offer-btn]');
	});
	
	it.skip('renders a button to cancel the trade', function () {
		domContext.assertOneOf('[data-ui=cancel-trade-btn]');
	});
	
	it.skip('when offer is invalid, the make offer button is disabled', function () {
		domContext.assertDisabled('[data-ui=make-offer-btn]');
	});
	
	describe.skip('when offer is valid', function () {
		beforeEach(function () {
			selectValidOffer();
		});
	...
	it.skip('clicking on the cancel trade button removes the widget', function () {
